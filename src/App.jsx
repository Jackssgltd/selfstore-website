            ...
            <div className="space-y-6">
              ...
              <div className="rounded-[2rem] border border-zinc-200 bg-zinc-50 p-8 shadow-sm">
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  <a href="https://www.selfstoregroup.co.uk/sites" className="rounded-2xl bg-[color:var(--brand)] px-5 py-4 text-center text-sm font-semibold text-white shadow-sm transition hover:opacity-90">Start Booking Flow</a>
                  <a href="https://www.selfstoregroup.co.uk/account/login" className="rounded-2xl border border-zinc-300 px-5 py-4 text-center text-sm font-semibold transition hover:border-[color:var(--brand)] hover:text-[color:var(--brand)]">Customer Login</a>
                </div>
              </div>
            </div>
          </div>
      ...
      return (
        <section className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-base leading-8 text-zinc-600">Ecom Base is established to assist small online retailers grow. By providing online business facilities, adjacent to your storage unit for ease of order processing and dispatch. The Ecom base office has ergonomic workstations, high speed internet to help with your e-commerce needs, a packing area to easily and comfortably pack and unpack deliveries to and from the site.</p>
            <p className="mt-4 text-base leading-8 text-zinc-600">The various bright and airy offices will provide a modern inspiring working environment, great transport links and many local food amenities within walking distance such as, Aldi, sandwich shops and fast-food outlets. ECOM BASE is a great place to meet other likeminded business people and interact and exchange experiences and exciting ideas to stay ahead of the ever-evolving e-commerce landscape.</p>
            <p className="mt-4 text-base leading-8 text-zinc-600">Ecom base can also introduce to a variety of financial and business consultants to help your business expand and eventually leave us. As part of the self store family you can join the Ecom base business club via a Monthly subscription.</p>
          </div>
        </section>
      );
    }
        ...
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6">
          <div className="flex items-center justify-between gap-4">
            <button onClick={() => goToPage("home")} className="flex min-w-0 items-center gap-3 text-left">
              <img src={LOGO_DATA} alt="SelfStore Group logo" className="h-14 w-auto shrink-0 object-contain sm:h-16" />
            ...
            <div className="hidden items-center gap-3 lg:flex">
              ...
              <a
  href="https://www.selfstoregroup.co.uk/account/login"
...
<a
  href="https://www.selfstoregroup.co.uk/sites"
    ...
    Book Now
      ...
      <footer className="border-t border-zinc-200 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-8 text-sm text-zinc-500 md:flex-row md:items-center md:justify-between">
          ...
          <div>Multi-page redesign with gallery, ready for your Storeganise links and final content.</div>
        </div>
      </footer>
    </div>
  );
